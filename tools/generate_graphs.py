"""
Unified Graph Generator for RGB-T Drone Pedestrian Detection
Generates:
1. Stage 1: Pedestrian Scale Distribution Chart
2. Stage 2: Multimodal Baseline Comparison Chart
3. Stage 3/4: Strategy A, B, and C Master Ablation Chart
"""
...
QUAL_DIR   = os.path.join(ROOT, "output", "qualitative_comparison")

for d in [GRAPHS_DIR, QUAL_DIR]:
...
def generate_stage1_graph():
    ...
    plt.close()
    print(f"[✓] Generated Stage 1 Scale Distribution Graph: '{output_path}'")
...
def generate_stage2_graph():
    ...
    plt.savefig(output_path, dpi=150)
    plt.close()
    print(f"[✓] Generated Stage 2 Baseline Comparison Graph: '{output_path}'")
...
def generate_ablation_graph():
    ...
    plt.close()
    print(f"[✓] Generated Ablation Graph: '{output_path}'")

def main():
    print("==================================================")
    print("  Generating Project Graphs (Relative Paths)")
    print("==================================================")
    generate_stage1_graph()
    generate_stage2_graph()
    generate_ablation_graph()
    print("==================================================")
    print(f"All graphs generated into: {GRAPHS_DIR}")
    print("==================================================")
